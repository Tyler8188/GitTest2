 ...
 * @LastEditTime : 2021-02-23 15:40:10
 * @FilePath: \RomantoryApp\assets\Framework\Utility\StringUtility.ts
 */
...
export class StringUtility {
    ...
    public static toHHmmss(data) {
        var day = Math.floor(data / (24 * 3600));
