...
# SDKWrapper中会通过反射创建SDKClassImpl对象，所以SDKClassImpl不能被混淆
-keep public class com.crater.romantory.SDKClassImpl

# cocos调用原生方法不能被混淆
-keep public class com.crater.romantory.BridgeUtils {
    public <methods>;
}